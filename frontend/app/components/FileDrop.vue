...
import { readableFileSize } from '~/helpers/media';
...
<template>
  <div class="dropzone" :class="{ 'drag-over': isDragOver }" @dragover.prevent @drop.prevent="handleFileDrop"
    @dragenter.prevent="dragEnter" @dragleave.prevent="dragLeave" @paste.prevent="handlePaste">
    <input ref="fileInput" type="file" @change="handleFileSelect" />
    <Icon name="material-symbols:layers-outline" size="40px" style="margin: 10px 0" />
    ...
    <div v-else>Drop file here or <span class="clickable" @click="triggerFileSelect">click to select from
        computer</span>.</div>
  </div>
</template>
